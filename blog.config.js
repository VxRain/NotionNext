...
const BLOG = {
  ...
  BIO: '', // 作者简介
  LINK: '', // 网站地址
  KEYWORDS: '树洞,又是一个树洞', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '2b33affa92a54f76a81f2195838cc368', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '树洞', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '又是一个树洞', // 站点描述，被notion中的页面描述覆盖
